  ...
  return (
    ...
    >
      ...
      <main className="w-[90%] lg:w-4/6 2xl:w-3/6 mx-auto mt-[6vh] lg:mt-[9vh]">
        ...
        <section className="mt-8 mb-[5vh]">
          {Articles.length > 0 ? (
            Articles.map((article: any, index: any) => (
              <Link key={index} href={"/blog/" + article.slug} passHref>
                <div className="bg-neutral-800 bg-opacity-50 py-6 px-5 lg:py-8 lg:px-6 text-left lg:text-sm my-5 hover:border-[1px] hover:border-neutral-500 hover:drop-shadow-lg hover:-translate-y-2 transition-all backdrop-blur-lg cursor-pointer">
                  <h1 className="text-3xl lg:text-4xl">{article.title}</h1>
                  ...
                  <p className="text-[12px] text-neutral-600 my-1">
                    {article.description}
                  </p>
                </div>
              </Link>
